...
- link:aula_um/codigos/onCreate.java[onCreate]
- link:aula_um/codigos/onStart.java[onStart]
- link:aula_um/codigos/onResume.java[onResume]
- link:aula_um/codigos/onPause.java[onPause]
- link:aula_um/codigos/onStop.java[onStop]
- link:aula_um/codigos/onDestroy.java[onDestroy]
