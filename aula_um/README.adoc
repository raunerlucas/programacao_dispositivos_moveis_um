...
image::ciclo_de_vida.png[]

- Referência da figura 2: GOOGLE DEVELOPERS. Entenda o ciclo de vida da atividade. Disponível em: https://developer.android.com/guide/components/activities/activity-lifecycle?hl=pt-br.

Métodos dos ciclos de vida:

- link:aula_um/codigo/onCreate.java[onCreate]
- link:aula_um/codigo/onStart.java[onStart]
- link:aula_um/codigo/onResume.java[onResume]
- link:aula_um/codigo/onPause.java[onPause]
- link:aula_um/codigo/onStop.java[onStop]
- link:aula_um/codigo/onDestroy.java[onDestroy]
